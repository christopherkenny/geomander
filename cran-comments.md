...
* This is a resubmission after 2 months from version 1.0.3. Thank you for the original comments.
...
* The largest change is (relatively) small data files which allow for vignettes to run without using the US Census Bureau API